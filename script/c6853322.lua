--Dragon Lord's Roaring return
local s,id=GetID()
function c6853322.initial_effect(c)
	--Activate
...
function s.filter(c,e,tp)
	return c:IsType(TYPE_XYZ)and c:IsSetCard(0x41A) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
