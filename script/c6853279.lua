--Ritual of the Ancient Dragon Lords
local s,id=GetID()
function c6853279.initial_effect(c)
	--Fusion/Ritual summon
	local fparams={fusfilter=aux.FilterBoolFunction(Card.IsSetCard,0x41A),extrafil=s.fextra}
	local rparams={filter=aux.FilterBoolFunction(Card.IsSetCard,0x41A),lvtype=RITPROC_GREATER,extrafil=s.rextra,extraop=s.extraop,forcedselection=s.rcheck}
