--Artificial Dragon Lord, Dracoionus
local s,id=GetID()
function c6853275.initial_effect(c)
	--synchro summon
...
function s.spfilter(c,e,tp)
	return c:IsSetCard(0x41A) and not c:IsType(TYPE_TUNER) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP_DEFENSE)
end
